  ...
  return (
    <div className="flex  flex-col items-center gap-5 px-3 md:px-14 py-10 bg-[#19251D] text-slate-50">
      ...
      <div className="flex items-center md:px-12">
        ...
        At TYC Africa Trust, we believe in the power of individuality. Our Talent Discovery program is designed to identify and nurture the unique abilities of every young person. Through specialized initiatives, we encourage the exploration and development of diverse talents.        </p>
