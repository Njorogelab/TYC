...
<div className="flex text-center md:px-12">
      ...
      <div className="flex items-center md:px-12 w-10/12">
        ...
        <span className="underline">Proven Impact: </span>Over the years, we&apos;ve witnessed countless success stories of individuals whose lives have been transformed through TYC Africa Trust's programs.</p>
          ...
          <li>
          <p className="text-2xl font-semibold text-center md:px-2">
          <span className="underline">Holistic Approach: </span>Holistic Approach: We don&apos;t just address the surface; we delve into the holistic development of youth—mind, body, and spirit.</p>
          </li>
          <li>
          <p className="text-2xl font-semibold text-center md:px-2">
          <span className="underline">Future Focus: </span>Future Focus: Our commitment extends beyond the present. We&apos;re dedicated to shaping a future where empowered youth become the catalysts for positive change in their communities.
</p>
          </li>
        </ul>
